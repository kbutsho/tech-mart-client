...
import banner from '@/assets/category/smartGadget-banner.jpeg'
...
const SmartGadgetCategory = ({ data }) => {
                        ...
                        <div className="col-md-8 col-xxl-9">
                            ...
                            <div className={styles.search_area}>
                                <input
                                    ...
                                    placeholder='search for smart gadget'
...
export default SmartGadgetCategory;
SmartGadgetCategory.getLayout = function getLayout(page) {
    return <MainLayout>{page}</MainLayout>;
};
export const getStaticProps = async () => {
    const productCategoryResponse = await fetch(`https://tech-mart-server.vercel.app/api/products?category=smart-gadget`);
