...
const EarphoneCategory = (props) => {
    const { status, price, discountPrice, name, coverPhoto, rating } = props.earphone;
        ...
        <div className='col-md-4 col-lg-3 col-xl-3 col-xxl-2 col-sm-6 col-6'>
            <div className={`${styles.product_card}`}>
                ...
                <div className=' d-flex justify-content-between'>
                    ...
                    <div>
                        <AiOutlineHeart onClick={() => handelAddToFavourite(props.earphone)}
                            className={`${styles.icon} ms-1`} />
                        {
                            status === PRODUCT_STATUS.IN_STOCK ?
                                <AiOutlineShoppingCart onClick={() => handelAddToCart(props.earphone)}
